...
<body>
  <main>
    <div class="container" style="margin-top: 20px;">
      <div class="row">
        <div class="col s12 grey-text text-darken-2"><b style="font-size: 37px">Add User</b>
          <br>
                ...
                <form action="<?php echo site_url('Users/save') ?> " method="post">
                  <div class="col s12">
                    <div class="input-field col s12">
                      <textarea name="Nama" placeholder="" class="materialize-textarea" class="validate" aria-describedby="inputGroupPrepend2" required></textarea>
                      <label for="Nama">Nama</label>
                    </div>
                    <div class="input-field col s12">
                      <textarea name="Hak_Akses" placeholder="" class="materialize-textarea" class="validate" aria-describedby="inputGroupPrepend2" required></textarea>
