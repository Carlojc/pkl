...
<body>
  <main>
    <div class="container" style="margin-top: 20px;">
      <div class="row">
        <div class="col s12 grey-text text-darken-2"><b style="font-size: 37px">Add Vendor</b>
          <br>
        ...
        <div class="col s12">
          <div class="card z-depth-3">
            <div class="card-content">
              <div class="row">
                <form action="<?php echo site_url('Vendors/save') ?> " method="post">
                  <div class="col s12">
                    <div class="input-field col s12">
                      <textarea name="Nama_Vendor" placeholder="" class="materialize-textarea" class="validate" aria-describedby="inputGroupPrepend2" required></textarea>
                      <label for="Nama_Vendor">Nama Vendor</label>
                    </div>
                    <div class="input-field col s12">
                      <textarea name="Alamat" placeholder="" class="materialize-textarea" class="validate" aria-describedby="inputGroupPrepend2" required></textarea>
                      <label for="Alamat">Alamat</label>
                    </div>
                    <div class="input-field col s12">
                      <textarea name="No_Telp" placeholder="" class="materialize-textarea" class="validate" aria-describedby="inputGroupPrepend2" required></textarea>
                      <label for="No_Telp">No Telepon</label>
                    </div>
                    <div class="input-field col s12">
                      <textarea name="No_Fax" placeholder="" class="materialize-textarea" class="validate" aria-describedby="inputGroupPrepend2" required></textarea>
                      <label for="No_Fax">Fax</label>
                    </div>
                    <div class="input-field col s12">
                      <textarea name="Email" placeholder="" class="materialize-textarea" class="validate" aria-describedby="inputGroupPrepend2" required></textarea>
