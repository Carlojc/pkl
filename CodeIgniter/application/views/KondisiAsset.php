...
<body>
  <main>
    <div class="container" style="margin-top: 20px;">
      <div class="row">
        <div class="col s12 grey-text text-darken-2"><b style="font-size: 37px">Kondisi Asset</b>
          <br>
              ...
              <div class="row" style="margin-bottom: 0px;">
                ...
                <div class="col s8">
                  <ul class="right" id="menu" style="margin-right: 20px; margin-top: 15px;">
                    <li><a class="waves-effect btn buttonWakwaw z-depth-0" href="<?= base_url('asset/addKondisi') ?>"><i class="material-icons left">add</i>Add Data</a></li>
                ...
                <tbody>
                  ...
                  foreach ($sql->result_array() as $row) :
                    ...
                    <tr>
                      ...
                      <td><?php echo $row['Kondisi_Asset']; ?></td>
                      <td><a class="buttonWakwaw" data-toggle="modal" data-target="#edit<?php echo $row['ID_Kondisi'] ?>" style="padding-left: 20px;" href="#"><i class="material-icons">edit</i></a>
                        <a class="buttonWakwaw" data-toggle="modal" data-target="#delete<?php echo $row['ID_Kondisi'] ?>" href="#"><i class="material-icons">delete</i></a>
                      </td>
                    </tr>

                    <!-- Modal Edit kondisi-->
                    <div class="modal" id="edit<?php echo $row['ID_Kondisi'] ?>">
                      <div class="modal-content">
                        <h5>Update Data Kondisi</h5>
                        <form action="<?php echo site_url('Kondisi/update') ?>" method="post">
                          <?php
                          $id = $row['ID_Kondisi'];
                          $sql = $this->db->query("SELECT * FROM kondisi_asset where ID_Kondisi = '$id'");

                          foreach ($sql->result_array() as $row) :
                            ?>

                            <input type="hidden" name="ID_Kondisi" value="<?php echo $row['ID_Kondisi']; ?>">

                            <div class="form-group">
                              <label>Kondisi Asset</label>
                              <input type="text" name="Kondisi_Asset" class="materialize-textarea" value="<?php echo $row['Kondisi_Asset']; ?>">
                            </div>
                     ...
                     <!-- Modal Delete -->
                     <div class="modal" id="delete<?php echo $row['ID_Kondisi'] ?>">
                      <form action="<?php echo base_url('Kondisi/delete') ?> " method="post">
                        <?php
                        $id = $row['ID_Kondisi'];
                        $sql = $this->db->query("SELECT * FROM kondisi_asset where ID_Kondisi = '$id'");
