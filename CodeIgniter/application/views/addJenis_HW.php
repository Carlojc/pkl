...
<head>
  ...
  <title>Add Jenis Hardware</title>
...
<body>
  <main>
    <div class="container" style="margin-top: 20px;">
      <div class="row">
        <div class="col s12 grey-text text-darken-2"><b style="font-size: 37px">Add Jenis Hardware</b>
          <br>
        ...
        <div class="col s12">
          <div class="card z-depth-3">
            <div class="card-content">
              <div class="row">
                <form action="<?php echo site_url('jenis_hw/save') ?> " method="post">
                  <div class="col s12">
                    <div class="input-field col s12">
                      <textarea name="Type_HW" placeholder="" class="materialize-textarea" class="validate" aria-describedby="inputGroupPrepend2" required></textarea>
                      <label for="Type_HW">Tipe Hardware</label>
                    </div>
                    <div class="input-field col s12">
                      <textarea name="Jenis_HW" placeholder="" class="materialize-textarea" class="validate" aria-describedby="inputGroupPrepend2" required></textarea>
                      <label for="Jenis_HW">Jenis Hardware</label>
                    </div>
                  </div>
