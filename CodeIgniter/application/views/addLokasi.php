...
<head>
  ...
  <title>Add Lokasi Data Center</title>
...
<body>
  <main>
    <div class="container" style="margin-top: 20px;">
      <div class="row">
        <div class="col s12 grey-text text-darken-2"><b style="font-size: 37px">Add Lokasi Data Center</b>
          <br>
                ...
                <form action="<?php echo site_url('Lokasi/save') ?> " method="post">
                  <div class="col s12">
                    <div class="input-field col s12">
                      <textarea name="Nama_Lokasi_DC" placeholder="" class="materialize-textarea" class="validate" aria-describedby="inputGroupPrepend2" required></textarea>
                      <label for="Nama_Lokasi_DC">Nama Lokasi</label>
                    </div>
                    <div class="input-field col s12">
                      <textarea name="Alamat_Lokasi_DC" placeholder="" class="materialize-textarea" class="validate" aria-describedby="inputGroupPrepend2" required></textarea>
                      <label for="Alamat_Lokasi_DC">Alamat Lokasi</label>
                    </div>
                  </div>
